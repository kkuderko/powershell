...
$emailToAddress = "admin@yourdomain.com"
$emailSMTPServer = "yourdomain.mail.protection.outlook.com"
$emailSubject = "Microsoft 365 MFA Report"

Send-MailMessage -Credential $credObject -Attachments $ExportDisabledCSV -From $emailFromAddress -To $emailToAddress -Subject $emailSubject -Body $Results -SmtpServer $emailSMTPServer -UseSSL
